...
The binary resolution rule is defined as follows: $$ \frac{ciao}{hey} $$ where $l_i$ is a literal and $\sigma$ is the most general unifier of $P(t_1,\dots,t_n)$ and $P(u_1,\dots,u_n)$.
...
$$ \frac{\{l_1,\dots,l_n,P(t_1,\dots,t_n)\}\{\not P(u_1,\dots,u_n),l_{n+1},\dots,l_m\}}{\{ l_1,\dots,l_m\}\sigma} $$ 
